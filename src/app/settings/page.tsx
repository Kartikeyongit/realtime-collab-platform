  ...
  return (
    <div style={{ maxWidth: '600px', margin: '0 auto', padding: '36px 24px' }}>
      ...
      <div className="card" style={{ padding: '24px' }}>
        ...
        <div style={{ marginBottom: '16px' }}>
          <label style={{ fontSize: '12px', fontWeight: 600, color: '#78716c', marginBottom: '6px', display: 'block' }}>New Password</label>
          <input
            type="password"
            value={newPassword}
        ...
        <div style={{ marginBottom: '20px' }}>
          <label style={{ fontSize: '12px', fontWeight: 600, color: '#78716c', marginBottom: '6px', display: 'block' }}>Confirm New Password</label>
          <input
            type="password"
        ...
        <button onClick={handlePasswordChange} disabled={savingPassword} className="btn btn-primary btn-sm" style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
